...
draft: false
image: ""
linktitle: "conectar-unity-con-nodejs"
...
Yo desarrollo el servidor con Typescript que luego se "transpila" a Javascript, pero se tiene que poder usar cualquier entorno.
...
{{<panel>}}Como el servidor usa JS elijo enviar los mensajes como JSON, hay que pasar de objeto C# a JSON y viceversa{{</panel>}}
